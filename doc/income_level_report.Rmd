...
Both Python and R programming languages were used in conjunction with the following packages: doctopt [@R_docopt; @py_docopt], requests [@requests], pandas[@mckinney-proc-scipy-2010], numpy [@oliphant2006guide], scikit-learn [@scikit-learn], pyarrow[@pyarrow], feather [@R_feather], knitr [@knitr], tidyverse [@tidyverse], plyr [@plyr], ggridges [@ggridges], ggthemes [@ggthemes], testthat [@testthat], and gridExtra [@gridExtra].
